      ...
      <div className="flex flex-col pt-32 w-[60%] items-center px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
            **Expand your workforce seamlessly.** Whether you need an agile
            offshore team or expert on-site professionals, we provide tailored
            staffing solutions for businesses of all sizes.
          </p>
          <p className="text-gray-600">
            Gain a **competitive edge** with scalable, cost-efficient, and
            high-performing talent—anywhere in the world.
          </p>
        </motion.section>
            ...
            {[
              {
                ...
                content:
                  "**Around-the-clock efficiency** with globally distributed teams.",
                icon: <BarChart3 className="w-8 h-8 text-blue-600 mb-4" />,
              },
              {
                title: "Dedicated Team Model",
                content:
                  "Hire **full-time dedicated teams** that integrate with your operations.",
              ...
              },
              {
                ...
                content:
                  "Our teams **adapt to remote and hybrid work models effortlessly.**",
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            **Expand globally, work smarter, and scale seamlessly.** Let&apos;s
            create your high-performing team now!
          </p>
